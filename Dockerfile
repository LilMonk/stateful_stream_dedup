...
ENV SPARK_TGZ_URL=https://archive.apache.org/dist/spark/spark-3.5.3/spark-3.5.3-bin-hadoop3-scala2.13.tgz \
    SPARK_TGZ_ASC_URL=https://archive.apache.org/dist/spark/spark-3.5.3/spark-3.5.3-bin-hadoop3-scala2.13.tgz.asc \
...
# Copy the log4j.properties file into the container
COPY src/main/resources/log4j.properties /opt/spark/conf/log4j.properties

# Copy the JAR file into the container
COPY target/StatefulStreamDedup-1.0-SNAPSHOT.jar /opt/spark/jars/StatefulStreamDedup-1.0-SNAPSHOT.jar
